...
| [I002](Invariants/002.md) | Every invariant links an existing test carrying its invariant marker. | [test_independent_project_delivery](../tooling/worker/src/scaffold/testing/test_delivery.py) |
...
| [I005](Invariants/005.md) | Agent shell tools accept only one top-level invocation of a catalogued Just recipe. | [test_shell_guard_rejects_bypass](../tooling/worker/src/hooks/tests/test_hooks.py) |
| [I006](Invariants/006.md) | Failed staged checks reject commits; repeated edits and corrections remain available, and unrelated unstaged work is excluded. | [test_staged_commit_preserves_unstaged_work](../tooling/worker/src/scaffold/git/tests/test_git.py) |
| [I007](Invariants/007.md) | Complexity reminders use the configured attention and full-refresh intervals. | [test_portable_reminder_schedule_retry_and_compaction](../tooling/worker/src/hooks/tests/test_reminders.py) |
...
| [I010](Invariants/010.md) | Direct master commits fail; integration uses current master, preserves feature commits, and retains the merged feature reference. | [test_divergent_rebase_preserves_merge_history](../tooling/worker/src/scaffold/git/tests/test_git.py) |
...
| [I012](Invariants/012.md) | Ledger edits receive matching skill guidance without a new edit denial, preserving existing guard and complexity decisions. | [test_ledger_edit_guidance](../tooling/worker/src/hooks/tests/test_hooks.py) |
...
| [I018](Invariants/018.md) | Changed source or executable mode invalidates current check evidence, and a selected passing check never claims a full passing gate. | [test_evidence_tracks_content_and_partial_checks](../tooling/worker/src/scaffold/evidence/tests/test_evidence.py) |
| [I019](Invariants/019.md) | Resume reports real merge and rebase conflicts without modifying repository contents. | [test_resume_observes_real_conflict](../tooling/worker/src/scaffold/memory/tests/test_resume.py) |
