...
| [I003](Invariants/003.md) | Committed decision identities, statements and details are immutable; application links preserve coverage except explicit D019 native replacements. | [test_committed_decisions_are_append_only](../tooling/tests/test_repo_policy.py) |
...
| [I013](Invariants/013.md) | Native hooks preserve established guidance, guard behavior, and reminder transitions. | [test_native_hook_contract](../tooling/tests/native/test_hooks.py) |
