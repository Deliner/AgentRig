...
| [I017](Invariants/017.md) | Installed Rust/Python language defaults block unnamed conditions, functions above 40 nonblank lines and signatures above 4 inputs; boundary values pass. | [test_strict_defaults_block_delivery](../tooling/tests/native/scaffold/test_strict.py) |
...
| [I020](Invariants/020.md) | A new installation records correct shipped checksums, executable flags and ownership while retaining the baseline after user edits. | [test_installation_manifest_records_ownership](../tooling/tests/native/scaffold/test_package.py) |
