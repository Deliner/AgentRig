...
| [P016](Plan/016.md) | pending | P013 | Scoped Rust boundary types and named values | Enforce configured project types at module boundaries and named constants in selected Rust logic, with explicit exceptions and architectural repair guidance. |
